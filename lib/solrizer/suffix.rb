      ...
      @config ||= OpenStruct.new :fields => [:type, :stored, :indexed, :multivalued, :vectors],
                                 ...
                                 type_suffix: (lambda do |fields|
                                   ...
                                   when :long
                                     ...
                                     raise Solrizer::InvalidIndexDescriptor, "Invalid datatype `#{type.inspect}'. Must be one of: :date, :time, :text, :text_en, :text_fr, :text_de, :text_fi, :text_se, :string, :symbol, :integer, :boolean"
                                   end
                                 end),
                                 stored_suffix: 's',
                                 indexed_suffix: 'i',
