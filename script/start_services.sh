...
docker run -d -t -p 8989:8983 -v $DIR/../tools/SimpleAnnotationServer/src/main/resources/solr:/imported_config --name newseye_sas_solr solr:7.5.0 solr-create -c annotations -d /imported_config
